...
let m4 = document.querySelector(".m4");
    ...
    let m4_4 = document.querySelector(".m4_4");
        let m4_4_table = document.querySelector(".m4_4_table");
        ...
        m4_4.addEventListener("click", function(){
            m4_4_table.classList.toggle("hide");
            m4_4.classList.toggle("white");
        })
...
let m5 = document.querySelector(".m5");
    ...
    let m5_2 = document.querySelector(".m5_2");
        let m5_2_table = document.querySelector(".m5_2_table");
    let m5_3 = document.querySelector(".m5_3");
        let m5_3_table = document.querySelector(".m5_3_table");
        ...
        m5_2.addEventListener("click", function(){
            m5_2_table.classList.toggle("hide");
            m5_2.classList.toggle("white");
        })
        m5_3.addEventListener("click", function(){
            m5_3_table.classList.toggle("hide");
            m5_3.classList.toggle("white");
        }) 
...
let main18 = document.querySelector(".main18");
let m18 = document.querySelector(".m18");

    let m18_1 = document.querySelector(".m18_1");
        let m18_1_table = document.querySelector(".m18_1_table");
    let m18_2 = document.querySelector(".m18_2");
        let m18_2_table = document.querySelector(".m18_2_table");
    let m18_3 = document.querySelector(".m18_3");
        let m18_3_table = document.querySelector(".m18_3_table");
    let m18_4 = document.querySelector(".m18_4");
        let m18_4_table = document.querySelector(".m18_4_table");

        main18.addEventListener("click", function(){
            m18.classList.toggle("hide");
            main18.classList.toggle("white");
        })
        m18_1.addEventListener("click", function(){
            m18_1_table.classList.toggle("hide");
            m18_1.classList.toggle("white");
        })
        m18_2.addEventListener("click", function(){
            m18_2_table.classList.toggle("hide");
            m18_2.classList.toggle("white");
        })
        m18_3.addEventListener("click", function(){
            m18_3_table.classList.toggle("hide");
            m18_3.classList.toggle("white");
        })
        m18_4.addEventListener("click", function(){
            m18_4_table.classList.toggle("hide");
            m18_4.classList.toggle("white");
        })
